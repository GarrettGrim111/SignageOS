...
const pass = "Tester!123"
  ...
  // this could be used when we want to make assertion on Integers inside input (only number can be inputed)
  // this implementation results into failed test due to used password (contains not a number elements)
  ...
  cy.writeFile('cypress/test_result.txt', 'Get password input, type inside value, check if value contains at least one number\n', { flag: 'a+' })
    ...
    cy.get('[data-testid=modal-header]', { timeout: 30000 })
